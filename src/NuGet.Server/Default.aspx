...
<%@ Import Namespace="NuGet.Server.Core.Infrastructure" %>
...
<div>
    ...
    <fieldset style="width:800px">
        ...
        Package Sources:
        <blockquote>
            <strong><%= Helpers.GetRepositoryUrl(ServiceResolver.Current.Resolve<ISettingsProvider>(), Request.Url, Request.ApplicationPath) %></strong>
        </blockquote>
        ...
        <% }
           ...
           { %>
            ...
            <blockquote>
                <strong>nuget.exe push {package file} {apikey} -Source <%= Helpers.GetPushUrl(ServiceResolver.Current.Resolve<ISettingsProvider>(),Request.Url, Request.ApplicationPath) %></strong>
            </blockquote>
        <% } %>
    </fieldset>
